...
// const NotesContent = ({ activeGroup }) => {
//   const [messages, setMessages] = useState([]);

//   useEffect(() => {
//     const savedMessages =
//       JSON.parse(localStorage.getItem(`notesMessages_${activeGroup.id}`)) || [];
...
//     console.log("Timestamp in onSendMessage:", timestamp); // Log timestamp
//     const newMessage = { content, timestamp };
  
//     setMessages((prevMessages) => {
//       const updatedMessages = [...prevMessages, newMessage];
//       localStorage.setItem(
//         `notesMessages_${activeGroup.id}`,
...
//         <img src={backLogo} alt="backLogo" className={styles.backIcon} onClick={goBack}/>
//         {activeGroup && (
...
//             >
//               {activeGroup.initial || generateInitial(activeGroup.name)}
//             </div>
...
//         )}
//       </div>
//       {activeGroup && <GroupTitle title={activeGroup.name} />}
//       <NotesDisplay messages={messages.map((message) => ({
//         ...message,
...
const NotesContent = () => {
  ...
  useEffect(() => {
    ...
    const savedMessages = JSON.parse(localStorage.getItem(`notesMessages_${groupId}`)) || [];
    setMessages(savedMessages);
  }, [groupId]);
